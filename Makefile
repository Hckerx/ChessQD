...
toexe:
	x86_64-w64-mingw32-g++ -g -c src/*.cpp -I include -std=c++17 -Wall -m64 && x86_64-w64-mingw32-g++ *.o -g -o bin/debug/main -L -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf && ./bin/debug/main && rm *.o
